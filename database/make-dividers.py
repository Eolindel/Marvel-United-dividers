...
if __name__ == "__main__":
    with open('Heroes-S1-S2.csv', newline='') as f:
...
""")
        ...
        if args.extensions == 'AS1S2':
            extensions = ['All-in S1','SG S1','Core Box S1','Tales of Asgard','Rise of the Blanck Panther','Guardians of the Galaxy Remix','Enter the Spider-Verse','First Class','The Horsemen of Apocalypse','Gold Team','Blue Team','Core Box S2','SG S2','Deadpool','X-Force','Fantastic Four','Phoenix Five','Days of the Future Past','All-in S2']
        elif args.extensions =='AS1':
            extensions = ['All-in S1','SG S1','Core Box S1','Tales of Asgard','Rise of the Blanck Panther','Guardians of the Galaxy Remix','Enter the Spider-Verse']
            ...
            shortExtensions = ["CB1","SGS1","ESV","GGR","RBP","TA","CB2","SGS2","BT","DFP","DP","FC","GT","HA","FF","PF","XF"]
            longExtensions = ["Core Box S1","SG S1","Enter the Spider-Verse","Guardians of the Galaxy Remix","Rise of the Blanck Panther","Tales of Asgard","Core Box S2","SG S2","Blue Team","Days of the Future Past","Deadpool","First Class","Gold Team","The Horsemen of Apocalypse","Fantastic Four","Phoenix Five","X-Force"]
        ...
        if drawLines == 'True':
            ...
            drawFilename = 'Ticks'
        outFile = 'dividers-heroes-{}-{}-{}-{}.tex'.format(args.extensions,language,drawFilename,orientation)
...
\usepackage[a4paper,twoside,top=5mm,bottom=5mm,inner=10mm,outer=10mm]{geometry}
""")
        else:
...
""")
                ...
                #Season
                out.write('\\node[anchor=base east] at (6.2,-0.55) {{\\scriptsize {} }};'.format(row[1])+'\n')
