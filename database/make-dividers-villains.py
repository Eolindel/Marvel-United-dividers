...
if __name__ == "__main__":
    with open('Villains-S1-S2.csv', newline='') as f:
...
""")
        ...
        if drawLines == 'True':
            ...
            drawFilename = 'Ticks'
        outFile = 'dividers-villains-{}-{}-{}-{}.tex'.format(args.extensions,language,drawFilename,orientation)
