...
if __name__ == "__main__":
    ...
    markers = [True,False]
    #markers = [False]
    extensions = ["AS1","AS2","AS1S2","CP1","CB1","SGS1","ESV","GGR","RBP","TA","CP2","CB2","SGS2","BT","DFP","DP","FC","GT","HA","FF","PF","XF"]
    extensionsFull=["All-in S1","All-in S2","All-in S1 S2","Core pledge S1","Core Box S1","SG S1","Enter the Spider-Verse","Guardians of the Galaxy Remix","Rise of the Blanck Panther","Tales of Asgard","Core pledge S2","Core Box S2","SG S2","Blue Team","Days of the Future Past","Deadpool","First Class","Gold Team","The Horsemen of Apocalypse","Fantastic Four","Phoenix Five","X-Force"]
        ...
        for lang in langs:
            ...
            for orientation in orientations:
                ...
                for marker in markers:
                    ...
                    os.system('./make-dividers.py -l {} -o {} -m {} -e {} >> outDivider'.format(lang,orientation,marker,extensionShort))
                    os.system('mv dividers-heroes-{}-{}-{}-{}.pdf {}/{}/{}/{}/'.format(extensionShort,lang,drawFilename,orientation,extension,lang,orientation,drawFilename))
